...
- Load the image `figs/rice.png`.
- Detect and count each ricecorn.
- Colour each detected ricecorn with a different colour.
- Save the output image as `figs/rice_coloured.png`.
